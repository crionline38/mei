class YearsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @year.save
        format.html { redirect_to @year, notice: 'Saison créée.' }
  ...
  def update
    respond_to do |format|
      if @year.update(year_params)
        format.html { redirect_to years_path, notice: 'Saison updatée.' }
  ...
  def destroy
    @year.destroy
    respond_to do |format|
      format.html { redirect_to years_url, notice: 'Saison effacée.' }
